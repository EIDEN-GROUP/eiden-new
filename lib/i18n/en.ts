...
export const en: Dictionary = {
  ...
  hero: {
    ...
    titleLead: "The structure that",
    titleAccent: "moves",
    titleTail: "your business forward.",
    description: "Strategy, creativity, digital, technology, content, and marketing: we bring together all the expertise needed to turn your challenges into concrete solutions. One team to imagine, build, and move your projects forward.",
    stats: [
  ...
  idea: {
    ...
    deckTitle: "A different way to build your business.",
    cards: [
      {
        label: "What stops",
        body: "Spending your time figuring out who can do what.",
        points: [
          "Managing multiple points of contact.",
          "Explaining your business over and over again.",
          "Juggling between different teams.",
          "Moving projects forward separately.",
          "Searching for new expertise every time a need arises.",
          "Spending your time coordinating everything."
        ],
      },
      {
        label: "What begins",
        body: "Having the right expertise brought together around your business.",
        points: [
          "A complete team by your side.",
          "All the expertise you need in one place.",
          "A deep understanding of your business.",
          "One strategy guiding every project.",
          "Complementary skills working together.",
          "A team ready for whatever comes next.",
        ],
      },
    ],
    stats: [
    ...
    items: [
      {
        ...
        text: "We lay the groundwork that gives your project a clear direction. Positioning, identity, art direction and editorial strategy line up to create an expression that is coherent, recognisable and fitted to your business.",
        deliverables: [
          "Positioning",
          "Naming",
          "Visual identity",
      ...
      },
      {
        ...
        text: "We design digital experiences fitted to your activity, your users and your goals. From the marketing site to the business platform, every build is meant to be fast, intuitive and able to grow with your business.",
        deliverables: [
          "Marketing sites",
          "E-commerce",
          "Web apps",
      ...
      },
      {
        ...
        text: "We build your visibility where your customers search, compare and choose. Google, generative engines and the new search interfaces become strategic points of contact that bring a qualified audience to your business.",
        deliverables: [
          "Technical SEO",
          "Content",
          "Link building",
      ...
      },
      {
        ...
        text: "We turn your marketing spend into measurable acquisition. Media strategy, targeting, creative, campaigns and optimisation work together to reach the right audiences and convert attention into results.",
        deliverables: [
          "Google Ads",
          "Social Ads",
          "Programmatic",
      ...
      },
      {
        ...
        text: "We create the images and the content that give your communication its force. Photos, videos, social formats and advertising content are produced to hold attention, say what you do and make people want to go further.",
        deliverables: [
          "Photography shoots",
          "Video production",
          "Reels",

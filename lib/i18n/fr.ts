...
export const fr = {
  ...
  hero: {
    ...
    description:
      "Nous créons des écosystèmes digitaux qui donnent aux marques les moyens de mieux se faire connaître, mieux communiquer et mieux convertir. De la stratégie au déploiement, EIDEN transforme le digital en véritable moteur de croissance.",
    stats: [
  ...
  services: {
    eyebrow: "Services — conseil, création et production",
    title: "Sept disciplines. Un seul niveau d'exigence.",
    hint: "Survolez une discipline pour voir le détail",
    deliverablesLabel: "Prestations & livrables",
    items: [
      {
        slug: "marque-identite",
        title: "Marque & Identité",
        kicker: "Identité, charte & territoire de marque",
        text: "L'art de l'impact immédiat et durable. Nous façonnons des chartes de rigueur et des identités visuelles d'une finesse chirurgicale, établissant votre autorité sectorielle dès le premier regard.",
        deliverables: [
      ...
      {
        slug: "web-developpement",
        title: "Site Web & Développement",
        kicker: "Site, e-commerce & maintenance",
        text: "Nous développons des sites internet ultra-rapides, modernes et faciles d'accès, conçus spécifiquement pour transformer vos visiteurs en clients.",
        deliverables: [
      ...
      },
      {
        slug: "photo-video",
        title: "Photo & Vidéo",
        kicker: "Contenu photo, film & motion",
        text: "Nous mettons en valeur votre entreprise grâce à des photos de haute qualité, des vidéos publicitaires captivantes et des présentations d'entreprise au rendu cinéma.",
        deliverables: [
      ...
      },
      {
        ...
        kicker: "Visibilité & génération de leads",
        text: "De la stratégie à l'acquisition de clients, nous renforçons votre visibilité en ligne, attirons des prospects qualifiés et soutenons durablement votre croissance.",
        deliverables: [
      ...
      },
      {
        ...
        kicker: "Intégrations & agents intelligents",
        text: "Nous orchestrons l'intégration systémique de vos logiciels et déployons des agents conversationnels intelligents, optimisant vos flux opérationnels pour libérer votre temps au quotidien.",
        deliverables: [
      ...
      },
      {
        ...
        kicker: "Méthodes, équipes & accompagnement",
        text: "Nous analysons vos méthodes de travail et coachons vos équipes chaque mois pour rendre votre entreprise plus structurée, efficace et performante.",
        deliverables: [
      ...
      {
        slug: "logiciels",
        title: "Logiciels propriétaires",
        kicker: "Outils sur mesure, CRM & tableaux de bord",
        text: "Nous créons des outils informatiques rien que pour vous (système de réservation, gestion d'école, etc.) sous forme d'un petit abonnement mensuel.",
        deliverables: [
  ...
  contact: {
    eyebrow: "Parlons-en",
    title: "Votre projet mérite un vrai plan.",
    text: "Dites-nous où vous en êtes. Nous répondons sous 48 heures, en français, en anglais ou en darija.",
    cta: "Réserver un appel",
    infoLabels: {
      email: "E-mail",
      phone: "Téléphone",

...
export const fr = {
  ...
  idea: {
    ...
    deckTitle: "Une autre façon de construire votre business.",
    cards: [
      {
        label: "Ce qui s'arrête",
        body: "Passer votre temps à chercher qui peut faire quoi.",
        points: [
          "Multiplier les interlocuteurs.",
          "Réexpliquer votre business à chaque fois.",
          "Jongler entre plusieurs équipes.",
          "Faire avancer les projets séparément.",
          "Chercher une nouvelle expertise à chaque besoin.",
          "Passer votre temps à coordonner.",
        ],
      },
      {
        label: "Ce qui commence",
        body: "Avoir les bonnes expertises réunies autour de votre business.",
        points: [
          "Une équipe complète à vos côtés.",
          "Toutes les expertises au même endroit.",
          "Une compréhension profonde de votre business.",
          "Une stratégie qui guide chaque projet.",
          "Des compétences qui se complètent.",
          "Une équipe prête pour ce qui vient ensuite."
        ],
      },
    ],
    stats: [
    ...
    items: [
      {
        ...
        text: "Nous posons les bases qui donnent une direction claire à votre projet. Positionnement, identité, direction artistique et stratégie éditoriale s’alignent pour créer une expression cohérente, reconnaissable et adaptée à votre business.",
        deliverables: [
          "Positionnement",
          "Naming",
          "Identité visuelle",
      ...
      },
      {
        ...
        text: "Nous concevons des expériences digitales adaptées à votre activité, vos utilisateurs et vos objectifs. Du site vitrine à la plateforme métier, chaque solution est pensée pour être performante, intuitive et capable d’évoluer avec votre business.",
        deliverables: [
          "Sites vitrines",
          "E-commerce",
          "Web-apps",
      ...
      },
      {
        ...
        text: "Nous développons votre visibilité là où vos clients cherchent, comparent et choisissent. Google, moteurs génératifs et nouvelles interfaces de recherche deviennent des points de contact stratégiques pour attirer une audience qualifiée vers votre business.",
        deliverables: [
          "SEO technique",
          "Content",
          "Netlinking",
      ...
      },
      {
        ...
        text: "Nous transformons vos investissements marketing en acquisition mesurable. Stratégie média, ciblage, création, campagnes et optimisation travaillent ensemble pour attirer les bonnes audiences et convertir l’attention en résultats.",
        deliverables: [
          "Google Ads",
          "Meta Ads",
          "Tiktok Ads",

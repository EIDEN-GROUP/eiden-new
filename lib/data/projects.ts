...
export const projectPages: ProjectPage[] = [
  ...
  },
  {
    ...
    title: {
      fr: "Ta parenthèse ensoleillée à Imi Ouaddar.",
      en: "Your sunlit break in Imi Ouaddar.",
    },
    hero: {
      image: "/work/web-lunja-vibes-cover.jpg",
      alt: { fr: "Site Lunja Village Vibes", en: "The Lunja Village Vibes site" },
    },
    challenge: {
      text: {
      ...
      points: [
        ...
        { fr: "Un ton à trouver", en: "A tone still to find" },
        { fr: "Beaucoup d'énergie à tenir", en: "A lot of energy to hold" },
      ],
    },
    idea: {
      statement: {
        fr: "Laisser la couleur porter, et lui donner de l'air.",
      ...
      alt: {
        fr: "Direction artistique Lunja Village Vibes",
        en: "Lunja Village Vibes art direction",
      },
    },
    built: [
      {
        title: { fr: "Direction artistique", en: "Art direction" },
        text: {
          fr: "Une palette assumée, tenue par l'espace plutôt que par la retenue.",
          en: "A palette taken head on, held by space rather than by restraint.",
        },
      },
      {
        title: { fr: "Design system", en: "Design system" },
        text: {
          fr: "Une hiérarchie typographique qui supporte trois couleurs fortes.",
          en: "A type hierarchy that can carry three loud colours.",
        },
      },
      {
        title: { fr: "Site web", en: "Website" },
        text: {
          fr: "Des animations en CSS pur, sans bibliothèque de motion.",
          en: "Motion in plain CSS, with no animation library.",
        },
      },
    ],
    work: [
      {
        ...
        image: "/work/web-lunja-vibes-desktop.jpg",
        alt: {
          fr: "Le site Lunja Village Vibes sur ordinateur",
          en: "The Lunja Village Vibes site on desktop",
        },
        caption: { fr: "Page d'accueil", en: "Homepage" },
      },
      {
        kind: "note",
        image: "/work/web-lunja-vibes-mobile.jpg",
        alt: {
          fr: "Le site Lunja Village Vibes sur téléphone",
          en: "The Lunja Village Vibes site on a phone",
        },
        title: { fr: "Sur téléphone", en: "Mobile experience" },
        text: {
          fr: "La palette tient au petit format parce que l'espace tient aussi. Rien n'a été resserré pour gagner un écran.",
          en: "The palette holds at small sizes because the spacing holds too. Nothing was tightened to save a screen.",
        },
      },
    ],
    result: {
      statement: {
        fr: "Trois couleurs difficiles, devenues la signature du lieu.",
        en: "Three difficult colours, turned into the signature of the place.",
      },
      changes: [
        {
          fr: "Une palette qui tient, du grand écran au téléphone.",
          en: "A palette that holds, from a wide screen down to a phone.",
        },
        {
          fr: "Une voix humaine, gardée pour les bons endroits.",
          en: "A human voice, kept for the right places.",
        },
        {
          fr: "Des animations légères, sans dépendance supplémentaire.",
          en: "Light motion, with no extra dependency.",
        },
      ],
    },
    info: {
      location: { fr: "Imi Ouaddar, Maroc", en: "Imi Ouaddar, Morocco" },
    },
  },
  {
  ...
  },
  {
    ...
    title: {
      fr: "Au cœur du commerce marocain moderne.",
      en: "At the heart of modern Moroccan retail.",
    },
    hero: {
      image: "/work/one retail hero.png",
      alt: { fr: "Site One Retail", en: "The One Retail site" },
    },
    challenge: {
      text: {
        fr: "Le site d'un groupe, c'est souvent un mur de logos. H&S Group avait sept enseignes derrière lui et avait besoin d'un endroit qui vaille la visite, pas d'un annuaire.",
        en: "A holding company site is usually a wall of logos. H&S Group had seven retail entities behind it, and needed a place worth visiting rather than a directory.",
      },
      points: [
        { fr: "Sept enseignes à relier", en: "Seven entities to connect" },
        { fr: "Un mur de logos à éviter", en: "A wall of logos to avoid" },
        { fr: "Aucune histoire de groupe", en: "No story for the group" },
      ],
    },
    idea: {
      statement: {
        fr: "Faire du groupe un endroit où l'on peut se promener.",
      ...
      alt: {
        fr: "Direction artistique One Retail",
        en: "One Retail art direction",
      },
    },
    built: [
      {
        title: { fr: "Direction artistique", en: "Art direction" },
        text: {
          fr: "Un système éditorial chaud, qui tient sept marques sans les écraser.",
          en: "A warm editorial system that holds seven brands without flattening them.",
        },
      },
      {
        title: { fr: "Architecture", en: "Architecture" },
        text: {
          fr: "Un explorateur d'écosystème : les enseignes, les secteurs, et ce qui les relie.",
          en: "An ecosystem explorer: the entities, the sectors, and what connects them.",
        },
      },
      {
        title: { fr: "Site web", en: "Website" },
        text: {
          fr: "Une refonte complète, du grand écran jusqu'au téléphone.",
          en: "A full build, from a wide screen down to a phone.",
        },
      },
    ],
    work: [
      {
        kind: "full",
        image: "/work/web-one-retail-desktop.jpg",
        alt: {
          fr: "Le site One Retail sur ordinateur",
          en: "The One Retail site on desktop",
        },
        caption: { fr: "L'écosystème", en: "The ecosystem" },
      },
      {
        kind: "note",
        image: "/work/web-one-retail-mobile.jpg",
        alt: {
          fr: "Le site One Retail sur téléphone",
          en: "The One Retail site on a phone",
        },
        title: { fr: "Sur téléphone", en: "Mobile experience" },
        text: {
          fr: "La carte des enseignes, pensée au survol sur ordinateur, devient une liste qui se parcourt au pouce.",
          en: "The map of entities, built for hover on desktop, becomes a list you move through with a thumb.",
        },
      },
    ],
    result: {
      statement: {
        fr: "Un groupe qui se visite, au lieu de se consulter.",
        en: "A group you visit, instead of one you look up.",
      },
      changes: [
        {
          fr: "Sept enseignes reliées par une seule langue visuelle.",
          en: "Seven entities connected by one visual language.",
        },
        {
          fr: "Un parcours qui explique le groupe, pas seulement sa liste.",
          en: "A path that explains the group, not just its list.",
        },
        {
          fr: "Une expérience qui tient sur les trois formats.",
          en: "An experience that holds across all three formats.",
        },
      ],
    },
    info: { location: { fr: "Maroc", en: "Morocco" } },

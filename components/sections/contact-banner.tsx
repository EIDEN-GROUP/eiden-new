...
export function ContactBanner() {
  ...
  return (
    <section id="contact" data-nav-tone="light" className="relative isolate w-full">
      ...
      <span
        aria-hidden
        className="absolute inset-0 -z-10 bg-[radial-gradient(115%_100%_at_50%_50%,rgba(18,38,32,0.92),rgba(18,38,32,0.72))]"
      />
      ...
      <div className="mx-auto flex h-svh max-w-full flex-col items-center justify-center px-5 py-16 text-center sm:px-8 sm:py-18">
        ...
        >
          ...
          <a
            ...
            className="text-canvas/60 hover:text-teal text-[0.875rem] tracking-wide transition-colors duration-300"
          >
            {siteConfig.email}
          </a>
        </Reveal>

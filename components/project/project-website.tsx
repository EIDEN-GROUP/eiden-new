    ...
    <section data-nav-tone="dark" className="grain bg-ink text-canvas">
      <div className="container-eiden py-20 sm:py-28">
        <Reveal direction="none" duration={0.5}>
          <p className="eyebrow text-canvas/35 text-center">{label}</p>
        </Reveal>
        ...
        <RevealWords
          ...
          delay={0.06}
          className="font-display text-canvas mx-auto mt-6 block max-w-3xl text-center text-[clamp(1.625rem,4vw,2.75rem)] leading-[1.1] font-bold tracking-[-0.03em]"
        />

        <Reveal delay={0.14}>
          <p className="text-canvas/55 mx-auto mt-5 max-w-2xl text-center text-[0.9375rem] leading-relaxed sm:text-base">
            {say(website.text)}
          </p>
        </Reveal>
        ...
        <Reveal delay={0.2} className="mt-14 sm:mt-20">
          <div className="relative mx-auto max-w-5xl">
            ...
            <div className="relative mx-auto -mt-8 w-2/5 max-w-[11rem] sm:absolute sm:right-[6%] sm:-bottom-10 sm:mt-0 sm:w-[18%]">
              <div className="ring-canvas/10 relative aspect-9/19 w-full overflow-hidden rounded-2xl shadow-[0_30px_70px_-30px_rgba(0,0,0,0.8)] ring-1">
                <Image
                  src={website.mobile}
                  alt=""
                  aria-hidden
          ...
          <Reveal delay={0.28}>
            <div className="mt-16 flex justify-center sm:mt-24">
              <a
                ...
                className="group text-canvas hover:text-gold inline-flex items-center gap-4 transition-colors duration-300"
              >

...
export function Process() {
  ...
  return (
    <Band>
      ...
      <RevealWords as="h2" text={say(copy.title)} delay={0.06} className="text-ink mt-12 block max-w-4xl text-[clamp(1.875rem,5vw,3.75rem)] uppercase"/>
...
export function Capabilities() {
  ...
  return (
    <Band>
      <RevealWords as="h2" text={say(copy.title)} className="text-ink block max-w-4xl text-[clamp(1.875rem,5vw,3.75rem)] uppercase" />
